...
// ** Context (문맥)
//    글이 지닌 방향성, 글(문장)이 궁극적으로 전달하려는 뜻이나 목적.
...
// => Context 적용 1.
//    Props로 onUpdate, onDelete 를 TodoItem 컴포넌트로 전달하는 과정에서
...
//    이때 인자 default_value는 생성시 적절한 Provider를 찾지못했을때만 사용되는값 
...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* 
      2) Provider 배치
        => Props로 Data를 공급받아야하는 컴포넌트들을 Provider로 감싼다.
        => Provider에 공급할 Data 를 전달(설정)
           value Props에 공급하려는 모든 Data를 객체로 담는다.  
