...
const Controller= ({ onChangeState }) => {
  ...
  // ** 이벤트 핸들러
  // => State가 정의된 부모 컴포넌트에 정의해야하고 이를 전달 받아 사용 
  ...
  // => 비교
  //    아래처럼 함수를 별도로 정의하더라도 어차피 매개변수 사용못함, 그러므로 직접 코드 작성
  //    -> 주로 화살표함수로 표기
  /*    function buttonClick(n) {
            onChangeState(n);
        }
        => onClick에 buttonClick(n)을 call 하는 코드
           onClick={ buttonClick } 
  */
    ...
    <div>
        ...
        {/* <button onClick={ onChangeState(-1) }>-1</button> 
          => 매개변수를 전달하기 위해 onClick 이벤트핸들러를 작성해서 
             ...
             그래서 전달받은 이벤트핸들러를 호출하는 함수를 정의하는 방식으로 구현 
        */}
