...
//    - 확장된 CSS 문법을 사용하여 CSS 코드를 쉽게 작성할 수 있도록 해주며
//    - 코드의 재활용성과 가독성을 높여줌
...
// => 그러므로 Body 컴포넌트에 Props로 값을 전달하기위해서는
...
function Body(props) { 
  ...
  // ** 조건문: jSx에서는 사용불가능하지만 컴포넌트에서는 사용가능 
  if (b2) {
    return (
      <div className='body'>
        <h1>** Body : JSX Test **</h1>
        ...
        <p>삼항식으로 n1+n2의 값이 짝수이면 '짝수' 아니면 '홀수' 출력하기</p>
    ...
    return (
      <React.Fragment> 
        ...
        <div>
          ...
          <p> if 조건문 Test 중 .....</p>
          <img src={img1} alt={'imageTest'} style={{width:150, height:150}} />
        ...
        <div>'최상위 Tag 규칙 : React.Fragment Tag로 감싸줌, 랜더링 되지않으므로 div 대신 사용'</div>
      </React.Fragment>
    );
  } //if
} //Body
